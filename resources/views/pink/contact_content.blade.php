                ...
                <ul>
                    <li class="text-field">
                        <label for="name-contact-us">
                            ...
                            <br />					<span class="sublabel">Укажите Ваше имя</span><br />
                        </label>
                    ...
                    <li class="text-field">
                        <label for="email-contact-us">
                            ...
                            <br />					<span class="sublabel">Укажите Ваш email</span><br />
                        </label>
                    ...
                    <li class="submit-button">
                        ...
                        <input type="submit" name="yit_sendmail" value="Отправить сообщение" class="sendmail alignright" />
                    </li>
                </ul>
            </fieldset>
        </form>
